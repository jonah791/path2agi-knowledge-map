...
# 统计物理（Statistical Physics）：从起源到 AI 的完整脉络
...
- [[16-complexity-science|复杂性科学]]：相变、幂律与临界性在复杂系统解释中反复出现
- [[15-cybernetics|控制论]]：朗之万动力学、随机控制与扩散过程在动态系统视角下彼此接近
...
- 与[[19-neuroscience|神经科学]]在 Hopfield 网络上形成交叉：联想记忆与自旋玻璃模型
