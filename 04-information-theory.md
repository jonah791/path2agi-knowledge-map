...
- [[14-signal-processing|信号处理]]：信息的传输、压缩、噪声抑制与编码问题直接连接信号处理
- [[22-linguistics|语言学]]：语言可以被视为一种信息编码系统，统计语言模型与压缩思想高度相关
- [[17-statistical-physics|物理学]]：熵在信息论与统计物理中具有深刻的对应关系
...
- 与[[14-signal-processing|信号处理]]在编码理论上紧密相关：信源编码、信道编码是信息论的经典应用
- 与[[17-statistical-physics|统计物理]]在熵概念上形成连接：Shannon 熵可视为 Boltzmann 熵的推广
