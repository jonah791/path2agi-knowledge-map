...
- [[11-operations-research|运筹学]]：运筹学处理单主体或统一目标下的优化，博弈论处理多主体相互影响的优化
- [[24-economics|经济学]]：经济学更系统讨论偏好、激励和机制设计，博弈论提供互动结构与均衡语言
- [[23-evolutionary-biology|进化生物学]]：演化稳定策略与复制者动力学把竞争与适应连接起来
- [[15-cybernetics|控制论]]：对抗控制、鲁棒控制与微分博弈共享“面向最坏情况”的思路
- [[22-linguistics|语言学]]：在多轮对话、协商与博弈语言行为分析中，策略性交互与语言使用相互交织
...
这里需要明确边界：RLHF 可以借用机制设计与战略交互的语言来分析，但它并不等于一个由博弈论完整刻画的问题。真正涉及偏好定义、效用聚合、制度设计与标注者激励时，仍需要回到[[24-economics|经济学]]专题中的偏好与对齐框架。
...
**与相邻篇章的关系**：
- 与[[24-economics|经济学]]共同研究激励与对齐问题：博弈论提供互动结构分析，经济学提供偏好建模与机制设计
- 与[[11-operations-research|运筹学]]在优化问题上形成对比：运筹学处理单目标优化，博弈论处理多目标冲突
- 与[[15-cybernetics|控制论]]在对抗控制上相关：鲁棒控制可理解为与"自然"的极小极大博弈
- 与[[23-evolutionary-biology|进化生物学]]在演化稳定策略上形成连接：演化博弈论研究策略的长期竞争
