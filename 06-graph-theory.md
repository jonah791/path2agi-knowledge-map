...
- [[14-signal-processing|信号处理]]：谱图方法把“图上的信号”推广为非欧几里得域上的滤波与卷积
- [[22-linguistics|语言学]]：依存句法树、语义图和知识图谱都把语言问题转化为图结构推理
...
- [[09-causal-inference|因果推断]] 和 [[05-logic|逻辑学]] 则把关系进一步提升到机制与规则层。
