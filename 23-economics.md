...
- [[22-game-theory|博弈论]]：博弈论分析互动结构与均衡，经济学进一步处理偏好、制度与激励设计
- [[21-operations-research|运筹学]]：运筹学更偏求解与资源配置，经济学更偏目标函数、效用与制度安排
- [[18-psychology|心理学]]：行为经济学大量吸收心理学关于偏差、启发式与偏好不稳定的发现
...
因此，这一章更适合从**偏好、激励、制度与对齐**的角度理解经济学对 AI 的贡献，而不是把所有与经济学相关的方法论都纳入其中。因果识别虽然在计量经济学传统中发展成熟，但在当前 25 学科结构中已经由独立专题“因果推断与结构因果模型”展开。
...
在 AI 语境下，这些方法对于推荐系统评估、广告增量收益分析、高影响决策系统以及离线强化学习中的反事实评估都非常重要。但从专题结构上看，这部分问题意识已经超出了本章“偏好、激励与对齐”的核心职责，因此在当前 25 学科结构中，由独立专题**因果推断与结构因果模型**系统展开。
...
不过，在当前 25 学科结构中，这部分内容由独立专题**因果推断与结构因果模型**系统展开；本章仅保留其作为经济学历史谱系的一部分，用来说明偏好、制度与部署后果分析之间的连接。
...
**与相邻篇章的关系**：
- 与[[22-game-theory|博弈论]]相邻：博弈论更强调互动结构和均衡概念，经济学更系统讨论偏好、福利、制度和机制设计。
- 与[[21-operations-research|运筹学]]分工：运筹学更像求解器与决策骨架，经济学则更像目标、激励与制度解释层。
- 与[[18-psychology|心理学]]互补：心理学解释人类反馈为何会有偏差，经济学研究如何在这种偏差下仍设计可用机制。
